            ...
            {isFirstLoad && (
              <div className="absolute inset-0 flex items-center justify-center z-50 bg-dark-deeper/80 backdrop-blur-sm">
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl text-primary-light mb-2">Loading Gebral Estate</h3>
                  <p className="text-gray-light text-sm">Connecting to data pipeline...</p>
                </div>
              </div>
            )}
            
            {!isPollingActive && (
              <div className="bg-warning/90 text-white text-sm py-1 px-3 rounded-md mb-4 flex items-center shadow-md animate-slide-in">
                <div className="p-1 rounded-full bg-warning/30 mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="flex-1">Data polling is currently inactive. Some information may not be updated.</div>
                <button 
